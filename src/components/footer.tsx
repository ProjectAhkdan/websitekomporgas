...
const Footer = () => {
  ...
  <nav>
    ...
    <p className=" max-w-lg">Jamantek merupakan UMKM service kompor panggilan terbaik. Berdiri sejak 2010 dan telah memiliki banyak teknisi tersebar ke seluruh Jabodetabek. Kini anda bisa memanggil teknisi service kompor hanya dirumah aja, hubungi kami sekarang.</p>
  </nav>
  <nav>
  ...
  <nav>
    ...
    <ul>
        <li>Jl. Raya Pasar Minggu No. 9B Pejaten Jakarta Selatan</li>
