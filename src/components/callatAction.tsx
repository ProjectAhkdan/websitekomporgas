  ...
  return (
    <div className=" overflow-hidden">
      <BackgroundGradientAnimation>
        <div className="absolute z-50 inset-0 grid grid-rows-2 gap-0 items-center justify-center text-black font-bold px-4 pointer-events-none text-xl text-center ">
          ...
          <div className=" w-full grid grid-cols-2 gap-4 z-50">
            ...
            <button className="btn btn-primary hover:cursor-pointer">
              <Link href="https://api.whatsapp.com/send?phone=6281214446687&text=Halo%20Jaya%20Mandiri%20Teknik%2C%20saya%20mau%20service&l=id">Whatsapp</Link>
            </button>
          </div>
        </div>
      </BackgroundGradientAnimation>
